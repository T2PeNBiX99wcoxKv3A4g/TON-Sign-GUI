...
class TabBodySetting : TabBodyBase() {
    ...
    override fun view(
        ...
        val forceSendTrue by remember { "gui.button.setting.force_send_true".i18nState() }
        val forceSendFalse by remember { "gui.button.setting.force_send_false".i18nState() }
        val refresh by remember { "gui.button.setting.refresh".i18nState() }
